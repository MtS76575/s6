...
try:
	...
	print R + ' _____  _   _    ___ ______  _____  _    _          _    _  _____ ______  _____ '.center(44)
	print "/  ___|| | | |  /   ||  _  \|  _  || |  | |        | |  | ||_   _|| ___ \|  ___|".center(44)
	print '\ `--. | |_| | / /| || | | || | | || |  | | ______ | |  | |  | |  | |_/ /| |__  '.center(44)
	print ' `--. \|  _  |/ /_| || | | || | | || |/\| ||______|| |/\| |  | |  |    / |  __| '.center(44)
	print W + ' '
	print ('/\__/ /| | | |\___  || |/ / \ \_/ /\  /\  /        \  /\  / _| |_ | |\ \ | |___ ').center(44)
	print ' \____/ \_| |_/    |_/|___/   \___/  \/  \/          \/  \/  \___/ \_| \_|\____/ '
...
def baliho():
	try:
		...
		print '\____/ \_| |_/    |_/|___/   \___/  \/  \/          \/  \/  \___/ \_| \_|\____/ '
		print ' ' + W
		print ('Society A').center(44)
		print (W + '     [' + G +'HERRAMIENTA PARA OBTENER INFORMACION DE FACEBOOK'+ W + ']')
		print ' '
####################################################################
#		    Print In terminal
def show_program():
 ...
 ------------------------------------------------------
    ...
    Creador     Azael C.Lorenzo
    Nombre       OSIF 'Open Source Information Facebook'
    CodeName   D3b2y
    version    full version
    Fecha      08/10/2020 09:35:12
    Team       SOCIETY A
    Email      azaelcl404@gmail.com
...
def info_ga():
  ...
  -------------       -------------------------------------
   ...
   get_data           Obtener datos de todos tus amigos
   get_info           Mostrar informacion sobre tus amigos

   dump_id            Obtener el ID de todos tus amigos
   dump_phone         Obtener numeros telefonicos de todos tus amigos
   dump_mail          Obtener correos electronicos de todos tus amigos
   dump_<id>_id       Obtenr informacion de algun amigo en especifico
		      ej: dump_nombredeusuario_id

   token              Iniciar sesion en tu cuenta
   cat_token          Ver sesion abierta
   rm_token           Salir de tu cuenta

   bot                Abrir menu de bot

   clear              Limpiar terminar
   help               Ver ayuda
   about              Ver informacion acerca del programa
...
def menu_bot():
 ...
 ---------   ------------------------------------
   ...
   [ 02 ]      Auto comentario
   [ 03 ]      auto poke
   [ 04 ]      Aceptar todas la solicitudes de amistad
   [ 05 ]      Eliminar todas tus publicaciones
   [ 06 ]      Eliminar tu lista de amigos
   [ 07 ]      Dejar de seguir a todos tus amigos
   [ 08 ]      Eliminar todas tus fotos
...
def get(data):
	...
	try:
		...
		print '[*] Se inicio de sesion se guardo en cookie/token.log'
		exit()
	except KeyError:
		print '[!] Intento de inicio de sesion fallido'
		print '[!] Revisa tu coneccion / email o contraseña'
		os.remove('cookie/token.log')
		main()
	except requests.exceptions.ConnectionError:
		print '[!] Fallo al intentar iniciar sesion'
		print '[!] Error de coneccion !!!'
		os.remove('cookie/token.log')
		main()
def id():
	print '[*] Inicia sesion con tu cuenta de Facebook         ';id = raw_input('[?] Username : ');pwd = getpass.getpass('[?] Password : ');API_SECRET = '62f8ce9f74b12f84c123cc23437a4a32';data = {"api_key":"882a8490361da98702bf97a021ddc14d","credentials_type":"password","email":id,"format":"JSON", "generate_machine_id":"1","generate_session_cookies":"1","locale":"en_US","method":"auth.login","password":pwd,"return_ssl_resources":"0","v":"1.0"};sig = 'api_key=882a8490361da98702bf97a021ddc14dcredentials_type=passwordemail='+id+'format=JSONgenerate_machine_id=1generate_session_cookies=1locale=en_USmethod=auth.loginpassword='+pwd+'return_ssl_resources=0v=1.0'+API_SECRET
	x = hashlib.new('md5')
        x.update(sig)
...
def post():
	...
	try:
	  if WT == 'wallpost':
		print '[*] Obteniendo todos los id de las publicaciones'
		...
		print '[*] Obteniendo los id de las publicaciones'
		...
		print '[*] Aceptando todas las solicitudes de amistad'
		...
		print '[*] Obteniendo el ID de todos tus amigos'
		...
		print '[*] Obteniendo la identificación de todos los álbumes'
		...
		print '[!] no se pudo recuperar toda la identificación de la publicación'
		print '[!] Detenido'
		bot()
	except requests.exceptions.ConnectionError:
		print '[!] Error de coneccion'
...
def like(posts , amount):
	...
	print '\r[*] ID de todas las publicaciones recuperado correctamente            '
	print '[*] Comenzando...'
		...
		for post in posts:
			...
			try:
				...
				try:
					...
					print '\r' + W + '[' + G + id + W + '] El proceso se llevo a cabo exitosamente'
		...
		for post in posts:
			...
			try:
				...
				try:
					...
					print W + '[' + G + id + W + '] Comentado con exito'
		print '[*] Hecho'
		bot()
	except KeyboardInterrupt:
                print '\r[!] Detenido'
...
def remove(posts):
	...
	print '\r[*] Toda la identificación de la publicación se recuperó correctamente          '
	print '[*] Comenzando...'
	...
	try:
		...
		for post in posts:
			...
			try:
				cek = a['error']['message']
				print W + '[' + R + post['id'] + W +'] Fallido'
			except TypeError:
				print W + '[' + G + post['id'] + W + '] Removido'
				counter += 1
		print '[*] Hecho'
		bot()
	except KeyboardInterrupt:
...
def confirm(posts):
	...
	print '\r[*] Todas las solicitudes de amistad recuperadas correctamente        '
	print '[*] Comenzando...'
	...
	try:
		...
		for post in posts:
			...
			try:
				cek = a['error']['message']
				print W + '[' + R + post['from']['name'] + W + '] Fallido'
			except TypeError:
				print W + '[' + G + post['from']['name'] + W + '] Confirmado'
		print '[*] Hecho'
		bot()
	except KeyboardInterrupt:
		print '\r[!] Detenido'
...
def unfollow(posts):
	...
	print '\r[*] Todos los ID recuperados con éxito    '
	print '[*] comenzando...'
	...
	try:
		...
		for post in posts['data']:
			...
			try:
				cek = a['error']['nessage']
				print W + '[' + R + post['name'] + W + '] fallido'
			except TypeError:
				print W + '[' + G + post['name'] + W + '] dejando de seguir'
		print '[*] Hecho'
		bot()
	except KeyboardInterrupt:
		print '\r[!] Detenido'
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'SH4DOW-WIRE' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaccion' + W + ' >> ')
	...
	if cek in ['1','01']:
		...
		try:
			...
			print '[!] Ya existe una sesion abierta'
			cek = raw_input('[?] Estas seguro que quieres continuar [Y/N] ')
			if cek.lower() != 'y':
				print '[*] Cancelando '
				bot()
		except IOError:
		...
		print '\n' + '[*] Iniciar sesion con tu cuenta de Facebook [*]'.center(44) + '\n'
		print '[Warn] Apague su VPN antes de usar esta función !!!'
		id()
	elif cek in ['0','00']:
		print '[!] Volver al menu de bot'
		bot()
		...
		if cek == '':
			...
			print "[!] El comando '" + cek + "' no existe"
			print "[!] Escriba 'menu' para mostrar el bot de menú"
			menu_reaction_ask()
  except KeyboardInterrupt:
	menu_reaction_ask()
...
def bot_ask():
	...
	print '[*] Cargando inicio de sesion '
	try:
		token = open('cookie/token.log','r').read()
		print '[*] Inicio de sesion exitoso'
	except IOError:
		print '[!] Inicio de sesion fallido'
		print "[!] Escriba 'token' para iniciar sesion en su cuenta"
		menu_reaction_ask()
	...
	if WT.upper() == 'T':
		...
		if id == '':
			print "[!] El objetivo de identificación no puede estar vacío"
			print '[!] Detenido'
			menu_reaction_ask()
...
def bot():
  try:
	...
	cek = raw_input(R + 'Sh4dow-Wire' + W +'/' + R +'Bot ' + W + '>> ')
	...
	if cek in ['1','01']:
		...
		if WT.lower() == "w" or WT.lower() == '':
			...
			id = raw_input('[?] Id del objetivo : ')

			if id == '':
				print "[!] El objetivo de identificación no puede estar vacía"
				print '[!] Detenido'
				bot()

		print '--------------------------------------------------'
		print " [Nota] Utilice el símbolo '</>' para cambiar la línea\n"
		...
		try:
			open('cookie/token.log')
			print '[!] Ya existe una sesion abierta'
			cek = raw_input('[?] Estas seguro de que quieres continuar [Y/N] ')
			if cek.lower() != 'y':
				print '[*] Cancelando '
				bot()
		except IOError:
		...
		print '\n' + '[*] Iniciar sesion en cuenta de Facebook [*]'.center(44) + '\n'
		print '[Advertencia] apague su VPN antes de usar esta función !!!'
		id()
	else:
		if cek == '':
			bot()
			...
			print "[!] El comando '"+cek+"' no existe"
			print '[!] Escribe "menu" para ver el menu bot'
			bot()
  except KeyboardInterrupt:
	bot()
#
...
def dump_id():
	...
	print '[*] Recuperando la identificación de todos los amigos'
	try:
		...
		out.close()
		print '\r[*] Todos los ID se obtuvieron con exito'
		print '[*] Archivo guardado : output/' + n[0].split(' ')[0] + '_id.txt'
		main()
		...
		print '[!] No se pudo recuperar la identificación del amigo'
		main()
...
def dump_phone():
	...
	print "[*] Buscando todos los números de teléfono"
	print '[*] comenzando...'
	...
	try:
		...
		out.close()
		print '[*] Hecho'
		print "[*] Todos los números de teléfono fueron obtenidos correctamente"
		print '[*] Archivo guardado : output/'+n[0].split(' ')[0] + '_phone.txt'
		main()
	except KeyboardInterrupt:
		print '\r[!] Detenido'
		main()
	except KeyError:
		print "[!] No se pudieron obtener todos los números de teléfono"
		main()
	except (requests.exceptions.ConnectionError , requests.exceptions.ChunkedEncodingError):
		print '[!] Error de coneccion'
		print '[!] Detenido'
...
def dump_mail():
	...
	print '[*] Obteniendo todos los correos electrónicos'
	print '[*] comenzando...'
	...
	try:
		...
		out.close()
                ...
                print '[*] Hecho'
                print "[*] Todos los correos electrónicos obtenidos correctamente"
		print '[*] Archivo guardado : output/' + n[0].split(' ')[0] + '_mails.txt'
		main()
		...
		print "[!] No se pudieron obtener todos los correos electrónicos"
		main()
	except (requests.exceptions.ConnectionError , requests.exceptions.ChunkedEncodingError):
		print '[!] Error de coneccion'
		print '[!] Detenido'
...
def dump_id_id():
	...
	print '[*] Obtener toda la informacion de tu amigo'
	...
	try:
		...
		print '\r[*] Toda la informacion se obtuvo con exito'
		print '[*] Archivo guardado : output/' + n[0].split(' ')[0] + '_' + target_id + '_id.txt'
		main()
	except KeyboardInterrupt:
		print '\r[!] Detenido'
		main()
...
def main():
  ...
  try:
	cek = raw_input(R + 'Sh4dow-Wire' + W +' >> ')

	if cek.lower() == 'get_data':
		if len(jml) == 0:
			getdata()
		else:
			print '[*] Haz recuperado %s los datos de tus amigos'%(len(jml))
			main()
	elif cek.lower() == 'get_info':
		print '\n'+'[*] Recopilación de información [*]'.center(44) + '\n'
		search()
	elif cek.lower() == 'bot':
		menu_bot()
		bot()
		...
		try:
			...
			print '[*] Tu inicio de sesion !!\n\n' + o + '\n'
			main()
		except IOError:
			print '[!] Falló al abrir cookie/token.log'
			print "[!] Escriba 'token' para iniciar sesion en su cuenta"
			main()
		...
		try:
			open('cookie/token.log')
			print '[!] Ya existe una sesion abierta'
			cek = raw_input('[?] Seguro que quieres continuar [Y/N] ')
			if cek.lower() != 'y':
				print '[*] Cancelando '
				bot()
		except IOError:
		...
		print '\n' + '[*] Iniciar sesion en tu cuenta de Facebook [*]'.center(44) + '\n'
		print '[Advertencia] apague su VPN antes de usar esta función !!!'
		id()
	elif cek.lower() == 'rm_token':
		print '''
[Advertencia] Debes volver a iniciar sesion en tu cuenta
       si eliminas el inicio de sesion
'''
		a = raw_input("[!] type 'delete' to continue : ")
		if a.lower() == 'delete':
			try:
				os.system('rm -rf cookie/token.log')
				print '[*] Eliminacion exitosa cookie/token.log'
				main()
			except OSError:
				print '[*] Fallo al intentar elimiar cookie/token.log'
				main()
		else:
			print '[*] Fallo al intentar eliminar cookie/token.log'
			main()
	...
	if 'dump_' in cek.lower() and cek.lower().split('_')[2] == 'id':
		...
		if cek == '':
			...
			print "[!] El comando '"+cek+"' no existe"
			print '[!] Escriba "help" para mostrar los comandos disponibles'
			main()
  except KeyboardInterrupt:
	main()
  except IndexError:
	print '[!] Parámetro inválido en comando : ' + cek
	main()
#
######################################################################################################################
...
def getdata():
	...
	try:
		...
		print '[!] Fallo al abrir cookie/token.log'
		print "[!] Escriba 'token' para iniciar sesion en su cuenta"
		main()

	print '[*] Obteniendo los datos de todos los amigos'
	...
	for i in a['data']:
		jml.append(i['id'])
		print '\r[*] Obteniendo %s datos de amigos'%(len(jml)),;sys.stdout.flush();time.sleep(0.0001)

	print '\r[*] '+str(len(jml))+' Datos de amigos obtenidos con éxito'
	main()
...
def search():
	...
	if len(jml) == 0:
                ...
                print '[!] Escriba "get_data" para recopilar datos de amigos'
                main()
        else:
                pass

	target = raw_input("[!] Buscar nombre o ID : ")

	if target == '':
		print "[!] Nombre o id no puede estar vacío !!"
		search()
	else:
		info(target)
	...
	for i in a['data']:
	  ...
	  if target in  i['name'] or target in i['id']:
		...
		try:
			...
			pass
		try:
			print '[*] Nombre de usario : '+y['username']
		except KeyError:
			pass
		try:
			print '[*] Email : '+y['email']
			...
			pass
		try:
			print '[*] Teléfono móvil : '+y['mobile_phone']
		except KeyError:
			pass
		try:
			print '[*] Nombre : '+y['name']
			...
			pass
		try:
			print '[*]  Nombre de pila : '+y['first_name']
		except KeyError:
			pass
		try:
			print '[*] Segundo nombre : '+y['middle_name']
		except KeyError:
			pass
		try:
			print '[*] Apellido : '+y['last_name']
		except KeyError:
			pass
		try:
			print '[*] Lugar : '+y['locale'].split('_')[0]
		except KeyError:
			pass
		try:
			print '[*] Locacion : '+y['location']['name']
		except KeyError:
			pass
		try:
			print '[*] Pueblo natal : '+y['hometown']['name']
		except KeyError:
			pass
		try:
			print '[*] Genero : '+y['gender']
		except KeyError:
			pass
		try:
			...
			pass
		try:
			print '[*] Estado de relacion : '+y['relationship_status']
		except KeyError:
			pass
		try:
			print '[*] Politica : '+y['political']
		except KeyError:
			pass
		try:
			print '[*] Trabajo :'
			...
			for i in y['work']:
				try:
					print '   [-] posicion : '+i['position']['name']
				except KeyError:
					pass
				try:
					print '   [-] empleo : '+i['employer']['name']
				except KeyError:
					pass
				try:
					if i['start_date'] == "0000-00":
					    ...
					    print'fecha de inicio : '+i['start_date']
				except KeyError:
					pass
				try:
					if i['end_date'] == "0000-00":
						...
						print '   [-] fecha final : '+i['end_date']
				except KeyError:
					pass
				try:
					print '   [-] locacion : '+i['location']['name']
				except KeyError:
					pass
				print ' '
		except KeyError:
			pass
		try:
			print '[*] Hora actualizada : '+y['updated_time'][:10]+' '+y['updated_time'][11:19]
		except KeyError:
			pass
		try:
			print '[*] Lenguajes : '
		...
		try:
			...
			pass
		try:
			print '[*] Citas : '+y['quotes']
		except KeyError:
			pass
		try:
			print '[*] Cumpleaños : '+y['birthday'].replace('/','-')
		except KeyError:
			pass
		try:
			print '[*] Link : '+y['link']
